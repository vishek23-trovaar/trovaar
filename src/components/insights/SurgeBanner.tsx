...
export function SurgeBanner() {
  ...
  return (
    <div className="bg-[#fbbf24]/10 border border-[#fbbf24]/30 rounded-xl p-4 mb-4">
      <div className="flex items-center gap-2 mb-2">
        <span className="text-lg">🔥</span>
        <span className="font-semibold text-[#fbbf24]">High Demand Alert</span>
      </div>
      <div className="space-y-1">
        {insights.map(insight => (
          <p key={insight.category} className="text-sm text-[#fbbf24]/80">
