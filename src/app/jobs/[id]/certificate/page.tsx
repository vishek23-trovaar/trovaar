...
function StarRow({ rating }: { rating: number }) {
  return (
    <span className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map((s) => (
        <span key={s} className={s <= rating ? "text-amber-400" : "text-[#8a8f98]"}>★</span>
      ))}
    </span>
  );
}
...
export default function CertificatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="bg-[#0f1011] border-4 border-primary/20 rounded-2xl shadow-xl overflow-hidden print:border-2 print:shadow-none print:rounded-none hover:shadow-2xl transition-shadow duration-500">
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          {/* Job title */}
          <div className="text-center border-b border-[#23252a] pb-5">
          ...
          {/* Details */}
          <div className="bg-[#010102] rounded-2xl p-5 space-y-3">
            ...
            <div className="flex justify-between items-center border-t border-[#23252a] pt-3">
          ...
          {cert.partsSummary && (
            <div>
              ...
              <p className="text-sm text-secondary bg-[#3B82F6]/10 rounded-lg px-4 py-3">{cert.partsSummary}</p>
            </div>
          )}
          ...
          {/* Footer */}
          <div className="border-t border-[#23252a] pt-4 text-center">
