...
export default function AdminSetupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#010102] to-[#0f1011] flex items-center justify-center p-4">
      <div className="bg-[#0f1011] rounded-2xl shadow-lg p-8 w-full max-w-md hover:shadow-xl transition-shadow duration-300" style={{ animation: "fadeInUp 0.5s ease-out" }}>
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-[#010102] rounded-2xl flex items-center justify-center shadow-md">
