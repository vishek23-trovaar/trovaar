              ...
              <div className="p-8 sm:p-10 flex flex-col justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link href="/jobs/new" className="flex-1">
                    <button className="w-full py-3 px-5 rounded-xl font-bold text-sm text-white cursor-pointer transition-all hover:opacity-90 active:scale-[0.98]"
                      style={{ background: "linear-gradient(90deg, #3b82f6, #6366f1)" }}>
                      Post a Job — It&apos;s Free
                    </button>
                  </Link>
                  <Link href="/signup" className="flex-1">
                    <button className="w-full py-3 px-5 rounded-xl font-bold text-sm text-white border border-white/20 hover:bg-white/10 cursor-pointer transition-all">
                      Learn More
                    </button>
                  </Link>
                </div>
