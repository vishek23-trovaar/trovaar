...
export default function GuaranteePage() {
  return (
    <div className="space-y-10">
      ...
      {/* Hero badge */}
      <div className="flex items-center gap-3 bg-[#3B82F6]/10 border border-[#3B82F6]/30 rounded-2xl px-5 py-4 shadow-sm">
        <svg className="w-8 h-8 text-[#60A5FA] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"
          />
        </svg>
        <div>
          <h2 className="text-lg font-bold text-[#60A5FA]">Trovaar Resolution Guarantee</h2>
      ...
      <section>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.step} className="flex items-start gap-4 bg-[#010102] rounded-2xl p-4 border border-[#23252a] hover:shadow-sm hover:bg-[#141516] transition-all duration-200">
              <span className="w-8 h-8 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-sm font-bold flex-shrink-0">{item.step}</span>
              <div>
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="bg-[#010102] rounded-2xl p-5 border border-[#23252a] hover:shadow-sm transition-shadow duration-200">
      ...
      <section>
        ...
        <div className="bg-[#fbbf24]/10 border border-[#fbbf24]/30 rounded-xl p-5 mb-4">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            <span className="mt-0.5 w-8 h-8 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-sm font-bold flex-shrink-0">1</span>
            <div>
          ...
          <div className="flex items-start gap-4">
            <span className="mt-0.5 w-8 h-8 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-sm font-bold flex-shrink-0">2</span>
            <div>
          ...
          <div className="flex items-start gap-4">
            <span className="mt-0.5 w-8 h-8 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-sm font-bold flex-shrink-0">3</span>
            <div>
          ...
          <div className="flex items-start gap-4">
            <span className="mt-0.5 w-8 h-8 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-sm font-bold flex-shrink-0">4</span>
            <div>
              ...
              <ul className="text-sm text-muted mt-2 space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <span className="text-[#60A5FA] mt-0.5 font-bold">→</span>
              ...
              <ul className="text-sm text-muted mt-2 space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <span className="text-[#34d399] mt-0.5 font-bold">→</span>
                  <span>The contractor receives <strong>full payment</strong>. The dispute is dismissed.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#f87171] mt-0.5 font-bold">→</span>
      ...
      <section>
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-start gap-3 bg-[#27a644]/10 border border-[#27a644]/30 rounded-lg p-4">
            <span className="text-[#34d399] mt-0.5">✓</span>
            <div>
              <p className="text-sm font-medium text-[#34d399]">Valid dispute</p>
              <p className="text-xs text-[#34d399] mt-0.5">&ldquo;I posted a video showing a leaking faucet and asked for it to be fixed. The contractor replaced the washer but the faucet still leaks.&rdquo;</p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-[#f87171]/10 border border-[#f87171]/30 rounded-lg p-4">
            <span className="text-[#f87171] mt-0.5">✕</span>
            <div>
              <p className="text-sm font-medium text-[#f87171]">Invalid dispute — add-on after the fact</p>
              <p className="text-xs text-[#f87171] mt-0.5">&ldquo;I posted about a leaking faucet but then also wanted the contractor to replace the garbage disposal. They only fixed the faucet.&rdquo;</p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-[#f87171]/10 border border-[#f87171]/30 rounded-lg p-4">
            <span className="text-[#f87171] mt-0.5">✕</span>
            <div>
              <p className="text-sm font-medium text-[#f87171]">Invalid dispute — subjective preference</p>
              <p className="text-xs text-[#f87171] mt-0.5">&ldquo;The paint color matches what I requested but I changed my mind and don&apos;t like it anymore.&rdquo;</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-start gap-3">
            <span className="w-6 h-6 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-xs font-bold flex-shrink-0">1</span>
          ...
          <div className="flex items-start gap-3">
            <span className="w-6 h-6 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-xs font-bold flex-shrink-0">2</span>
          ...
          <div className="flex items-start gap-3">
            <span className="w-6 h-6 rounded-full bg-[#3B82F6]/10 flex items-center justify-center text-[#60A5FA] text-xs font-bold flex-shrink-0">3</span>
      ...
      <section>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="bg-[#fbbf24]/10 border border-[#fbbf24]/30 rounded-lg p-4 text-center">
            <div className="text-3xl mb-1">⚠️</div>
            <p className="font-semibold text-[#fbbf24] text-sm">Strike 1</p>
            <p className="text-xs text-[#fbbf24] mt-1">Warning issued. Dispute noted on record.</p>
          </div>
          <div className="bg-[#fbbf24]/10 border border-[#fbbf24]/30 rounded-lg p-4 text-center">
            <div className="text-3xl mb-1">🚨</div>
            <p className="font-semibold text-[#fbbf24] text-sm">Strike 2</p>
            <p className="text-xs text-[#fbbf24] mt-1">Profile deprioritized in search. New bids restricted.</p>
          </div>
          <div className="bg-[#f87171]/10 border border-[#f87171]/30 rounded-lg p-4 text-center">
            <div className="text-3xl mb-1">🚫</div>
            <p className="font-semibold text-[#f87171] text-sm">Strike 3</p>
            <p className="text-xs text-[#f87171] mt-1">Account deactivated. Removed from platform.</p>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="bg-[#3B82F6]/10 border border-[#3B82F6]/30 rounded-2xl p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-[#60A5FA] mb-2">Questions?</h2>
